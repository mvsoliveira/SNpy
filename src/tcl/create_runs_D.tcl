...
set runname [format "I%03d_O%03d_D%03d_MUON_SORTER" $I $O $D]
...
set cfgs []
#lappend cfgs [list 16 16 [range 1 1]]
#lappend cfgs [list 32 16 [range 1 1]]
#lappend cfgs [list 24 16 [range 1 1]]
#lappend cfgs [list 40 16 [range 1 1]]
#lappend cfgs [list 56 16 [range 1 1]]
lappend cfgs [list 352 16 [range 1 6]]
#lappend cfgs [list 64 16 [range 1 1]]
#lappend cfgs [list 88 16 [range 1 1]]
#lappend cfgs [list 104 16 [range 1 1]]
