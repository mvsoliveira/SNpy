...
HD_PWD='/vol1/msilva_selsrv1/sorting/hls/design_exploration2/nomux_rebuit1/sorting_nomux/I352_O016_D007_II1_M0_F1_IR1_R1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
