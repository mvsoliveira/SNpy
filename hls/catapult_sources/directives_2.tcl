...
solution options set /Clustering/rom_threshold 40000
solution options set /Prototyping/MaxLoopIterations 10000
solution options set /Prototyping/AreaOptParallelism 4
solution options set /Architectural/DefaultRegisterThreshold 3000
solution options set /Output/GenerateCycleNetlist false
solution file add ../../catapult_sources/comparator_test_nomux.cpp -type C++ -exclude true
solution file add ../../catapult_sources/sorting_nomux.cpp -type C++
...
directive set /compare_main -GATE_REGISTERS false
directive set -ROM_THRESHOLD 40000
directive set -REGISTER_THRESHOLD 3000
