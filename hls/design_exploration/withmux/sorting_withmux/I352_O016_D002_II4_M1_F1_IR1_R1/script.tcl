...
open_solution "I352_O016_D002_II4_M1_F1_IR1_R1"
set_part {xcvu9p-flgc2104-1-e}
create_clock -period 6.25 -name default
config_export -format syn_dcp -rtl verilog -vivado_synth_design_args {-directive sdx_optimization_effort_high -flatten_hierarchy rebuilt}
set_clock_uncertainty 0.8
source "./sorting_withmux/I352_O016_D002_II4_M1_F1_IR1_R1/directives.tcl"
csim_design
csynth_design
cosim_design
