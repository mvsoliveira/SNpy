proc create_run {I O D {run 1} opt} {
    ...
    set prjpre [format "I%03d_O%03d_D%03d_CSN_SEL_VHDL" $I $O $D]
	...
	add_file -vhdl    ${basepath}/src/rtl/custom_sorting_network/csn_sel_wrapper.vhd
	...
	add_file -vhdl    ${basepath}/src/rtl/wrapper_csn_sel.vhd
	...
	set_option -top_module wrapper_csn_sel
    ...
    project -run compile
    cd ${basepath}/syn
    export_project -instance dut_inst -add_file {../src/rtl/custom_sorting_network/csn_pkg.vhd ../src/rtl/custom_sorting_network/csn_cmp.vhd ../src/rtl/custom_sorting_network/csn.vhd ../src/rtl/custom_sorting_network/csn_sel_wrapper.vhd} -no_default_hdl -project $subprjpath
	...
	add_file -constraint ${basepath}/src/xdc/muon_sel_csn.sdc
    switch $opt {
	freq160retfan10000 {
...
#lappend cfgs [list 8 2 [range 0 0]]
#lappend cfgs [list 352 64 [range 0 0]]
lappend cfgs [list 352 64 [range 12 14]]
