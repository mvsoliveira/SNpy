proc create_run {I O D {run 1} opt} {
    ...
    set prjpre [format "I%03d_O%03d_D%03d_BITONIC_NOSUBPRJ_HARD" $I $O $D]
	...
	freq160retfan10000 {
		...
		add_file -constraint ${basepath}/src/xdc/wrapper_hard.sdc
	}
	freq160retfan16 {
	    set_option -frequency 160
...
set cfgs []
set opts [list freq320retfan10000 freq160retfan10000]

#lappend cfgs [list 16 16 [range 0 2]]
#lappend cfgs [list 16 2 [range 0 2]]
lappend cfgs [list 16 16 [range 1 4]]
